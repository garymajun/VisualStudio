...
1. In Visual Studio, select **Team Explorer** from the **View** menu. TODO: Insert screenshot
2. In the Team Explorer pane, click the **Manage Connections** toolbar button. TODO: Insert screenshot
3. Click the **Connect** link in the GitHub section. If you are already connected to a GitHub instance and want to connect to another, this link will not be visible; instead click **Manage Connections** and then **Connect to GitHub**. TODO: Insert screenshot
